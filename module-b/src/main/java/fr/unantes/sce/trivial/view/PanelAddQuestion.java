		...
		public PanelSouth()
		{
			...
			sauvegarder.addActionListener(new ActionListener()
			{
				...
				public void actionPerformed(ActionEvent e)
				{
					...
					// Obtenir l'auteur
					String author = "Moi"; //TODO Quoi faire pour l'auteur? Recuperer login et activer le add question que quand on est logg�?
					...
					for(int i=0; i<4;i++)
					{
						//On parcourt le tableau des 4choix de reponses associ�s � leur boolean respectif
