...
public class Window extends JFrame
{
	...
	private Audio son;
	boolean activer = true; // Son activer/d�sactiver
	...
	private Boolean isAdmin; //true si connect� en tant qu'administrateur pour ajouter ou supprimer des questions
	private Boolean isConnected; // true si un joueur est connect�
	
	private Gamer player; //joueur qui est connect� au jeu
	...
	private void desactiveButtonsQuestions()
	{
		...
		//d�sactivation du bouton login //TODO changer par le nom de la personne
