...
public class GameBoard 
{
	...
	private void fillGameBoard(){
		...
		addSquare(begin);
		//correspond au num�ro id des cat�gories pour les CaseQuestionCamembert
		int numCamembert=1;
		
		//Boucle qui va remplir le plateau des diff�rentes cases 
		while(begin.getNbCase()!=NB_SQUARE){
			
			//cr�ation des cases camemberts
	...
	/**
	 * Cette m�thode renvoie la cat�gorie de la case dont l'id est pass� en param�tre
	 * @param id
	 * @return Category
	 */
