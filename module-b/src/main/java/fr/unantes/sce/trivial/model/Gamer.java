...
import fr.unantes.sce.trivial.utility.Encrypt;
...
public class Gamer implements Serializable
{
	...
	public Gamer(String login, String password, String email, String firstName, String surName, String dateBirth) throws BirthdayGamerException, EmailGamerException 
	{
		...
		nbGamer++;
		statg = new StatGamer(nbGamer,nbGamer); // Le joueur sera plac� en fin de classement, ce sera donc											  
											    // le dernier �l�ment du classement par victoire et du classement par points.
	}
